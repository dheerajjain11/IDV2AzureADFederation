...
namespace Thinktecture.IdentityServer.Web.Controllers
{
    public class AccountController : AccountControllerBase
    {
        ...
        public ActionResult SignIn()
        {
            ...
            string client_request_id = Request.QueryString["client-request-id"];
            string username = Request.QueryString["username"]==null?string.Empty: Request.QueryString["username"];
            string realm = Request.QueryString["wtrealm"];
            bool mobile = Request.QueryString["mobile"]==null?false:bool.Parse(Request.QueryString["mobile"]);
